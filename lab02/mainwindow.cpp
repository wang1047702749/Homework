...
{
    qDebug()<<"right";
    QColor selectcolor= QColorDialog::getColor(Qt::white,0,tr("颜色选取"));
    qDebug()<<selectcolor;
    if(selectcolor.isValid())
    {
        QPixmap pixmap(20, 20);
        pixmap.fill (selectcolor);
